...
import { FolderOpen, Calendar, Wrench } from 'lucide-react';
...
export default function AdministrationPage() {
  ...
  const hasAccess = user.departments?.includes('Administration') || user.is_admin;
          ...
          >
            <div className="text-center space-y-8">
              <div className="flex justify-center">
                <div className="w-24 h-24 bg-gradient-to-br from-slate-400 to-gray-500 rounded-2xl flex items-center justify-center shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Administrative and support function tools coming soon to the OAG Data Portal.
                </p>
              </div>
              ...
              <Card className="backdrop-blur-lg bg-white/80 border-white/20 shadow-lg max-w-2xl mx-auto">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-gray-600">
                    We're building administrative support and management tools
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800">
                          This module is scheduled for development in Phase 4 of the OAG Data Portal expansion. 
                          Administrative support tools and resource management features are being designed.
                        </p>
                      </div>
                    </div>
                  </div>
