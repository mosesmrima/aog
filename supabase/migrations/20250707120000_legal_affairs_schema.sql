/*
  # Legal Affairs Cases Schema Migration

  1. Tables
    - legal_affairs_cases: Main table for storing legal case records
    - legal_affairs_import_batches: Tracks batch imports for audit purposes

  2. Security
    - Enable RLS on all tables
    - Create policies for read/write access based on user roles
    - Authenticated users can read all cases (open access model)
...
-- Create updated_at trigger (reuse existing function from previous migration)
